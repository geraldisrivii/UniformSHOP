<template>
    ...
    <RegisterDialog v-model:email="userRegister.email" v-model:password="userRegister.password" v-model:login="userRegister.login"
...
export default {
    ...
    async beforeCreate() {
        ...
        let response = await WP.post('/sessions', {}, {
