    ...
    <section class="first-section">
        <div class="first-section-container container">
            ...
            <div class="first-section-description">
                ...
                <div class="first-section-description__price-box">
                    <p v-if="product.sale_price" class="first-section-description__sale-price">{{ product.sale_price }} ₽ </p>
                    <p class="first-section-description__price"
                        :class="{ 'first-section-description__price_has-sale': product.sale_price }"> {{
                            product.regular_price }} ₽ </p>
                </div>
                <div class="diginties first-section-description-diginties">
                    <Diginity v-for="(diginity, index) in product.cfs.diginities" :key="index"
                        class="first-section-description-diginties__item" :lineWidth="100" :title="diginity.title"
                        :text="diginity.text" />
